...
export const StretchScreenContext = createContext(
  {} as IStretchScreenContextValue,
);
...
export function StretchScreenProvider({
  children,
}: IStretchScreenProviderProps) {
  ...
  const toggleStretch = useCallback(() => {
    setIsStretched((prevState) => {
      localStorage.setItem(
        localStorageKeys.STRETCHED_SCREEN,
        String(!prevState),
      );
      return !prevState;
    });
